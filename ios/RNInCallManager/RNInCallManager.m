...
- (void)updateAudioRoute
{
  ...
  if (_forceSpeakerOn == 0 || [self isBluetoothConnected] || [self isWiredHeadsetPluggedIn]) { // use default behavior
...
{
  return [self checkAudioRoute:@[AVAudioSessionPortBluetoothA2DP]
                     routeType:@"output"]
  || [self checkAudioRoute:@[AVAudioSessionPortBluetoothHFP]
                 routeType:@"output"];
}
